# -*- coding: utf-8 -*-
"""
Created on Mon Nov 15 12:50:33 2021
...
def password(length, num=False, strength='weak'):
    """
    length of password, num if you want a number, and strength (weak, strong, very strong) 
    """
...
print(password(15, num=True, strength="very strong"))
